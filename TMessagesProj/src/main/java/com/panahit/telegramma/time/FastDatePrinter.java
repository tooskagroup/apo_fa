...
public class FastDatePrinter implements DatePrinter, Serializable {
     ...
     */
    protected FastDatePrinter(final String pattern, final TimeZone timeZone, final ULocale locale) {
        mPattern = pattern;
        mTimeZone = timeZone;
        mLocale = locale;
     ...
     */
    static String getTimeZoneDisplay(final TimeZone tz, final boolean daylight, final int style, final ULocale locale) {
    ...
    private static class TimeZoneNameRule implements Rule {
         ...
         */
        TimeZoneNameRule(final TimeZone timeZone, final ULocale locale, final int style) {
            mLocale = locale;
            mStyle = style;
    ...
    private static class TimeZoneDisplayKey {
        ...
        TimeZoneDisplayKey(final TimeZone timeZone,
                           final boolean daylight, final int style, final ULocale locale) {
            mTimeZone = timeZone;
            if (daylight) {
