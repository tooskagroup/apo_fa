...
public class FastDateParser implements DateParser, Serializable {
     ...
     */
    protected FastDateParser(final String pattern, final TimeZone timeZone, final ULocale locale) {
     ...
     * @since 3.3
     */
    protected FastDateParser(final String pattern, final TimeZone timeZone, final ULocale locale, final Date centuryStart) {
    ...
    private static String[] getDisplayNameArray(int field, boolean isLong, ULocale locale) {
    ...
    private static Map<String, Integer> getDisplayNames(int field, ULocale locale) {
     ...
     */
    private static Map<String, Integer> getDisplayNames(final int field, final Calendar definingCalendar, final ULocale locale) {
    ...
    private static final ConcurrentMap<ULocale, Strategy>[] caches = new ConcurrentMap[java.util.Calendar.FIELD_COUNT];
     ...
     */
    private static ConcurrentMap<ULocale, Strategy> getCache(final int field) {
        synchronized (caches) {
            if (caches[field] == null) {
                caches[field] = new ConcurrentHashMap<ULocale, Strategy>(3);
            }
            return caches[field];
        }
    }
    ...
    private Strategy getLocaleSpecificStrategy(final int field, final Calendar definingCalendar) {
        final ConcurrentMap<ULocale, Strategy> cache = getCache(field);
    ...
    private static class TextStrategy extends Strategy {
         ...
         */
        TextStrategy(final int field, final Calendar definingCalendar, final ULocale locale) {
            this.field = field;
    ...
    private static class TimeZoneStrategy extends Strategy {
         ...
         */
        TimeZoneStrategy(final ULocale locale) {
