...
import com.panahit.telegramma.BuildVars;
...
import com.panahit.ui.Cells.CheckBoxCell;
import com.panahit.ui.Cells.EmptyCell;
import com.panahit.ui.Cells.HeaderCell;
import com.panahit.ui.Cells.ShadowSectionCell;
import com.panahit.ui.Cells.TextCheckCell;
import com.panahit.ui.Cells.TextDetailSettingsCell;
import com.panahit.ui.Cells.TextInfoCell;
...
import com.panahit.ui.Components.NumberPicker;
    ...
    public View createView(Context context) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, final int i, long l) {
                ...
                } else if (i == calendarRow) {
                    presentFragment(new CalendarSelectActivity());
    ...
    private class ListAdapter extends BaseFragmentAdapter {
        ...
        public boolean isEnabled(int i) {
            return i == textSizeRow || i == enableAnimationsRow || i == notificationRow || i == backgroundRow || i == numberRow ||
                    ...
                    i == mobileDownloadRow || i == clearLogsRow || i == roamingDownloadRow || i == languageRow || i == calendarRow || i == usernameRow ||
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (type == 0) {
                ...
                if (i == textSizeRow) {
                    ...
                    textCell.setTextAndValue(LocaleController.getString("Calendar", R.string.Calendar), LocaleController.getCurrentCalendarName(), true);
                } else if (i == contactsSortRow) {
                    String value;
                    SharedPreferences preferences = ApplicationLoader.applicationContext.getSharedPreferences("mainconfig", Activity.MODE_PRIVATE);
